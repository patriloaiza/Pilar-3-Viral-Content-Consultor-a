...
export const ResultsView: React.FC<ResultsViewProps> = ({
  ...
  const handleDownloadClientHtml = () => {
    ...
    downloadFile(
      html,
      `${safeFileName(state.clientName)}_informe_viral_content.html`,
    ...
    <div id="results-view" className="space-y-6 animate-fade-in pb-16">
        ...
        <div className="flex flex-wrap items-center justify-between gap-4 pb-6 border-b border-gray-800">
          <div>
            ...
            <h1 className="text-2xl sm:text-3xl font-black text-white leading-tight">
              Expediente Estratégico · Pilar 3 Viral Content
            </h1>
            <p className="text-sm text-gray-400 mt-1 max-w-2xl">
              Radiografía diagnóstica con hoja de ruta productizada alineada a 9 fases de Viral Content ($1,200 — $2,500 USD) para {state.clientName || 'Cliente'}.
            </p>
          </div>
      ...
      <div className="flex border-b border-gray-200 gap-2">
        ...
        >
          ...
          <span>Las 30 Preguntas Clave</span>
        </button>
      </div>
      ...
      {/* PESTAÑA: TODAS LAS PREGUNTAS (30) */}
      {activeTab === 'all' && (
        <div className="space-y-4">
          <div className="text-xs text-gray-500 font-medium">
            Listado completo de los 30 reactivos aplicados en la sesión:
          </div>
          <div className="space-y-3">
