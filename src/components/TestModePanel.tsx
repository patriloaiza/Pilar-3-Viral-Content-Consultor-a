      ...
      <div className="flex flex-wrap items-center justify-between gap-3 pb-4 border-b border-gray-800">
        <div>
          ...
          <p className="text-xs text-gray-400 mt-1 max-w-xl">
            Verificación metodológica de los 30 reactivos de Viral Content, cobertura de las 9 fases
            del servicio ($1,200 — $2,500 USD) y detección de señales de contraste (verdad vs discurso). No altera la información de tu
            sesión de trabajo.
          </p>
        </div>
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          >
            ...
            {isRunning ? 'Ejecutando...' : 'Ejecutar batería de 20 pruebas'}
          </button>
        </div>
      </div>
